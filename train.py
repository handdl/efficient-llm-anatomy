...
class SyntheticDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        tokens = torch.randint(0, self.vocab_size, (self.seq_len,), generator=generator)
        return tokens
...
def main():
    ...
    parser.add_argument(
        "--alpha", type=float, default=2.0, help="AdEMAMix alpha coefficient for mixing slow and fast EMAs"
    )
    parser.add_argument("--beta3-warmup", type=int, default=None, help="Number of warmup steps for beta3")
    parser.add_argument("--alpha-warmup", type=int, default=None, help="Number of warmup steps for alpha")
